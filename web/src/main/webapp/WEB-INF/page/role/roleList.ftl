...
<#list roleList as role>
	<tr>
		...
		<td><a href="javascript:void();" onclick="javascript:roleOper.editRole('<#if role.roleId??>${role.roleId}</#if>')" style="cursor: pointer;">编辑</a>
			<a href="javascript:void();" onclick="javascript:roleOper.showRole('<#if role.roleId??>${role.roleId}</#if>')" style="cursor: pointer;">查看</a> 
			<a href="javascript:void();" onclick="javascript:roleOper.deleteRole('<#if role.roleId??>${role.roleId}</#if>')" style="cursor: pointer;">删除</a>
		</td>
	</tr>
</#list>
</#if>
